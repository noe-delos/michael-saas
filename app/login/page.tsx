        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-12 text-white">
          <div className="max-w-md">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              ...
              vos techniques de vente avec Michaël Aguilar, conférencier expert
              certifié CSP.
            </p>
        ...
        <div className="w-full max-w-md space-y-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="email"
                    required
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0D3D60] focus:border-transparent transition-all duration-200"
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              ...
              <a
                href="#"
                className="font-medium text-[#0D3D60] hover:text-[#DAB475]"
              >
