      ...
      <motion.section variants={item}>
        ...
        <div className="flex gap-6">
          ...
          <div className="hidden lg:block w-80">
            <Card className="h-[15rem] bg-gradient-to-br from-[#0D3D60] via-[#0D3D60] to-[#DAB475] border-amber-200/50 flex items-center justify-center shadow-soft overflow-hidden">
              <div className="text-center">
                ...
                <p className="text-xs text-white/90 mb-4 max-w-[15rem] drop-shadow-sm">
                  Michaël Aguilar • Expert certifié CSP
                </p>
                <Button
                  variant="default"
                  size="sm"
