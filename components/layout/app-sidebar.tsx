      ...
      <SidebarContent className="scrollbar-hide">
        <SidebarGroup>
          <SidebarGroupLabel className="text-lg font-bold mb-4 pt-4 flex items-center gap-2">
            <img src={"/logo.png"} className="size-fit w-[14rem]" />
          </SidebarGroupLabel>
          <SidebarGroupContent className="pt-4">
            <div className="mb-4">
              <Link href="/simulation/configure">
                <Button className="w-[60%] michael-gradient font-bold hover:brightness-105 py-5 border-amber-200/50 text-white transition-opacity">
