            ...
            {step < 4 && (
              <div
                className={`w-14 h-0.5 ${
                  step < currentStep ? "bg-[#0D3D60]" : "bg-gray-200"
                }`}
              />
            )}
          </div>
      ...
      <div className="flex justify-between">
        ...
        {currentStep < 4 ? (
          ...
          <Button
            ...
            className="bg-[#0D3D60] hover:bg-[#0A2E4B] cursor-pointer"
          >
            {startingSimulation ? (
